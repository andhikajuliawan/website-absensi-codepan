...
<html lang="en">
  ...
  <body class="body">
    <div
      class="container-fluid full-home"
      style="
        height: 100vh;
    ...
    >
      <div class="container pt-4">
        <div class="row justify-content-between">
          ...
          <div class="col-3 text-end">
            <a href="{{ route('dashboard') }}" role="button" class="btn btn-outline btn-md rounded-pill px-4 btn-login">Login</a>
          </div>
        </div>
      </div>
      <!-- Navabar -->
      ...
      <div class="container">
        <div
          ...
          style="height: 70vh; margin-top: 90px"
        >
