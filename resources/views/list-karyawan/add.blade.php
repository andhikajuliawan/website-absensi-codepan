            ...
            <div class="row mx-3 bg-white px-2 py-4 justify-content-evenly shadow-lg" style="border-radius: 10px">
                ...
                <div class="col-md-6 mb-1 ">
                    ...
                    <input type="text" name="password" class="form-control" id="exampleFormControlInput1"
                        placeholder="Silahkan Masukkan Password" value="{{ old('password') }}" />
                    @error('password')
                        <p class="text-danger mt-1 mb-1 " style="font-size: 12px">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-6 mb-1 ">
                    ...
                    <input type="text" name="fullname" class="form-control" id="exampleFormControlInput1"
                        placeholder="Silahkan Masukkan Full Name" value="{{ old('fullname') }}" />
                    @error('fullname')
                        <p class="text-danger mt-1 mb-1 " style="font-size: 12px">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-6 mb-1 ">
                    ...
                    <input type="text" name="username" class="form-control" id="exampleFormControlInput1"
                        placeholder="Silahkan Masukkan Username" value="{{ old('username') }}" />
                    @error('username')
                        <p class="text-danger mt-1 mb-1 " style="font-size: 12px">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-6 mb-1 ">
                    ...
                    <input type="text" name="phone" class="form-control" id="exampleFormControlInput1"
                        placeholder="Silahkan Masukkan Nomor Telephone" value="{{ old('phone') }}" />
                    @error('phone')
                        <p class="text-danger mt-1 mb-1 " style="font-size: 12px">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-md-6 mb-1 ">
                    ...
                    <input type="text" name="divisi" class="form-control" id="exampleFormControlInput1"
                        placeholder="Silahkan Masukkan Divisi" value="{{ old('divisi') }}" />
                    @error('divisi')
                        <p class="text-danger mt-1 mb-1 " style="font-size: 12px">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-4 ">
                    ...
                    <input type="text" name="address" class="form-control" id="exampleFormControlInput1"
                        placeholder="Silahkan Masukkan Alamat Rumah" value="{{ old('address') }}" />
                    @error('address')
                        <p class="text-danger mt-1 mb-1 " style="font-size: 12px">{{ $message }}</p>
                    @enderror
                </div>
