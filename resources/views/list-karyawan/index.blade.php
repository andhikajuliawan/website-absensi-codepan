                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center text-sm">
                                        <form action="{{ route('karyawans.show', ['karyawan' => $user->id]) }}"
                                            method="GET" style="display: inline ; padding:0px">
                                            @csrf
                                            @method('GET')
                                            <button type="submit">
                                        ...
                                        <form action="{{ route('karyawans.edit', ['karyawan' => $user->id]) }}"
                                            method="GET" style="display: inline; padding:0px">
                                            @csrf
                                            @method('GET')
                                            <button type="submit">
                                        ...
                                        <form action="{{ route('karyawans.destroy', ['karyawan' => $user->id]) }}"
                                            method="POST" style="display: inline;  padding:0px">
                                            @csrf
                                            @method('DELETE')
