                        ...
                        @foreach ($financials as $financial)
                            <tr>
                                ...
                                <td class="text-center text-sm">
                                    <form action="{{ route('financials.show', ['financial' => $financial->id]) }}"
                                    ...
                                    <form action="{{ route('financials.edit', ['financial' => $financial->id]) }}"
                                        method="GET" style="display: inline">
                                        @csrf
                                        @method('GET')
                                        <button type="submit">
                                    ...
                                    <form action="{{ route('financials.destroy', ['financial' => $financial->id]) }}"
