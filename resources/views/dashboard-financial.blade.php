...
<div class="container-fluid py-4">
    <div
      class="row mx-3 bg-white px-2 py-4 shadow"
    ...
    >
      ...
      <div class="table-responsive">
        <table class="table table-hover table-sm align-middle">
          ...
          <tbody>
            <tr>
              <td class="text-center text-sm" scope="row">02/20/2022</td>
              <td class="text-center text-sm">Pembayaran tagihan wifi</td>
              <td class="text-center text-sm" style="color: #28a745">-</td>
