    ...
    <div class="container-fluid py-4">
        <div class="row mx-3 bg-white px-2 py-4 shadow" style="border-radius: 10px">
            ...
            <div class="col text-end">
                ...
                <span><a href="#"><button type="button" class="btn btn-primary" style="background-color: #2196f3">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center text-sm">
                                <span><a href="#view"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    ...
                                    <a href="#edit" class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <tr>
                            ...
                            <td class="text-center text-sm">
                                <span><a href="#view"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    ...
                                    <a href="#edit" class="mx-2"><svg xmlns="http://www.w3.org/2000/svg"
